...
def computer_P(x, X):
    """ Computer P from pairs of 2D-3D (in homog. coordinates). """
...
class RansacModel(object):
    """ Class for fundmental matrix fit with ransac.py. """
    ...
    def fit(self, data):
        ...
        # tranpose and split data into the two point sets
        data = data.T
        x1 = data[:3, :8]
        x2 = data[3:, :8]
    ...
    def get_error(self, data, F):
        ...
        # transpose and split data in to the two point
        data = data.T
        x1 = data[:3]
        x2 = data[3:]
        ...
        err = (np.diag(dot(x1.T, dot(F, x2)))) ** 2/ denom 
